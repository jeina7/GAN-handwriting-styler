...
<p align="center">]Generated by model]</p>
...
손글씨를 모두 학습한 모델은 위와 같이 사람의 손글씨를 따라 쓸 수 있게 됩니다. 위에 쓰여있는 '내 손글씨를 따라 쓰는 인공지능' 13자는 모두 모델이 학습한 210자에 포함되지 않은 글자입니다. 즉, 모델은 사람이 직접 쓴 모든 글자를 다 학습하지 않고 일부만을 학습했지만, 나머지 글자들을 비슷한 스타일로 생성할 수 있습니다.
